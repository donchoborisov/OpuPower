...
<div class="text-center w mt-8">


   <p class="text-green-700 bg-green-600 bg-opacity-20 text-lg p-4">{{Session::get('success')}}</p>
</div>
      ...
      <div
        ...
        <div class="flex flex-col justify-between">
          <div>
            ...
            <div class="text-gen  text-gray-700 mt-8">
        ...
        <div class="">
          ...
          <form  wire:submit.prevent="send">@csrf
          <div class="{{ $errors->has('name') ? 'has-error' : '' }}">
            <span class="uppercase text-sm font-title text-gray-600 font-bold">Full Name</span>
            <input wire:model="name" class="w-full ring-sec focus:ring-1 bg-gray-300 text-gray-900 mt-2 p-3 bg-our-bg rounded-lg focus:outline-none focus:shadow-outline"
          ...
          <div class="mt-8 {{ $errors->has('email') ? 'has-error' : '' }}">
            ...
            <input wire:model="email" class="w-full ring-sec focus:ring-1 bg-gray-300 text-gray-900 mt-2 p-3 bg-our-bg rounded-lg focus:outline-none focus:shadow-outline"
              type="text" name="email" placeholder="Email">
              <span class="text-red-700 bg-red-600 bg-opacity-20 text-xs rounded">{{ $errors->first('email') }}</span>
          </div>
          <div class="mt-8  {{ $errors->has('email') ? 'has-error' : '' }}">
            <span class="uppercase font-title text-sm text-gray-600 font-bold">Message</span>
            <textarea wire:model="message"
              class="w-full ring-sec focus:ring-1 h-32 bg-gray-300 text-gray-900 mt-2 p-3 bg-our-bg rounded-lg focus:outline-none focus:shadow-outline" name="message" placeholder="Your message..."></textarea>
              <span class="text-red-700 bg-red-600 bg-opacity-20 text-xs  rounded">{{ $errors->first('message') }}</span>
            </div>
          ...
          <div class="mt-8 text-center">
            ...
            <x-button
              ...
              <span class="animate-spin" wire:loading wire:target="send">&#9696;</span>
